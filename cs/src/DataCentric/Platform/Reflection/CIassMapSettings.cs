...
namespace DataCentric
{
    ...
    public interface IClassMapSettings
    {
        ...
        ICollection<string> IgnoredNamespacePrefixes { get; }

        /// <summary>Namespace suffixes including dot separators ignored by class mapping.</summary>
        ICollection<string> IgnoredNamespaceSuffixes { get; }

        /// <summary>Class name prefixes ignored by class mapping.</summary>
        ICollection<string> IgnoredClassNamePrefixes { get; }

        /// <summary>Class name prefixes ignored by class mapping.</summary>
        ICollection<string> IgnoredClassNameSuffixes { get; }

        /// <summary>Method name prefixes ignored by class mapping.</summary>
        ICollection<string> IgnoredMethodNamePrefixes { get; }

        /// <summary>Method name prefixes ignored by class mapping.</summary>
        ICollection<string> IgnoredMethodNameSuffixes { get; }
    }
}
