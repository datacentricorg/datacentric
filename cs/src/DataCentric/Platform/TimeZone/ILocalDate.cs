...
{
    /// <summary>
    /// Provides local date and the timezone in which it is defined.
    ///
    ...
    public interface ILocalDate
    {
        ...
        /// <summary>
        /// Timezone used to convert between UTC datetime and local date.
        ///
        /// By convention, throughout this library datetime is always in UTC
        /// while date, time, and minute are always in a specific timezone.
        /// </summary>
    ...
    /// <summary>Extension methods for ILocalDate.</summary>
    public static class ILocalDateEx
    {
    }
}
