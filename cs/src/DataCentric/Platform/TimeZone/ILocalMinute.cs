...
{
    /// <summary>
    /// Provides local minute and the timezone in which it is defined.
    ///
    ...
    /// </summary>
    public interface ILocalMinute
    {
        /// <summary>
        /// Local minute in the specified timezone.
        ///
        /// By convention, throughout this library datetime is always in UTC
        /// while date, time, and minute are always in a specific timezone.
        /// </summary>
        LocalMinute? Minute { get; }

        /// <summary>
        /// Timezone used to convert between UTC datetime and local minute.
        ///
        /// By convention, throughout this library datetime is always in UTC
        /// while date, time, and minute are always in a specific timezone.
        /// </summary>
    ...
    /// <summary>Extension methods for ILocalMinute.</summary>
    public static class ILocalMinuteEx
    {
    }
}
