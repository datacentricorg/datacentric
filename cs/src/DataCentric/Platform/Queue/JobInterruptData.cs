...
namespace DataCentric
{
    ...
    /// </summary>
    public sealed class JobInterruptData : RecordFor<JobInterruptKey, JobInterruptData>
    {
        /// <summary>Job to which the interrupt record applies.</summary>
        [BsonRequired]
        public JobKey Job { get; set; }

        /// <summary>Action requested by the interrupt record.</summary>
        [BsonRequired]
        public JobInterruptType? InterruptType { get; set; }
    }
}
